...
<head>
 <meta charset="utf-8">
    ...
    <title>FAM | Administrador Fuerte al Medio  </title>
<?php 
...
<nav class="navbar navbar-default" style=" border-radius: 0px !important; border-bottom: 1px solid green ; ">
  <div class="container-fluid">
    ...
    color: #0f585c;
    letter-spacing: 3px;"> FUERTEALMEDIO  |  </span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li  >
        	<a href='<?php echo site_url('administrador/carrusel')?>'><i class="fa fa-image"></i>  Carrusel Home <span class="sr-only">(current)</span></a>
        </li>
        <li>
        	<a href='<?php echo site_url('administrador/publicacion')?>'><i class="fa fa-comment"></i> Publicaciones </a>
        </li> 
